...
--changeset rmorenko:state
create table action (id bigint generated by default as identity, name varchar(255), spel varchar(255), primary key (id));
create table deferred_events (jpa_repository_state_id bigint not null, deferred_events varchar(255));
create table guard (id bigint generated by default as identity, name varchar(255), spel varchar(255), primary key (id));
create table state (id bigint generated by default as identity, initial_state boolean, kind integer, machine_id varchar(255), region varchar(255), state varchar(255), submachine_id varchar(255), initial_action_id bigint, parent_state_id bigint, primary key (id));
...
create table state_machine (machine_id varchar(255) not null, state varchar(255), state_machine_context bytea, primary key (machine_id));
create table transition (id bigint generated by default as identity, event varchar(255), kind integer, machine_id varchar(255), guard_id bigint, source_id bigint, target_id bigint, primary key (id));
