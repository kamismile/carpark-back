...
--changeset dbegun:2018-06-09-1
update location set address = '(Станция обсуживнаия) Лубянский пр-д, 9 строение 1, Москва, 101000' where id =4;
update location set address = '(ЦО) Лубянский пр-д, 9 строение 1, Москва, 101000' where id =1;